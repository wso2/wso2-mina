...
public interface IoFilterChain {
    ...
    /**
     * Returns the {@link IoFilter.NextFilter} of the {@link IoFilter} with the
     ...
     *             if {@link IoFilter#onPostAdd(IoFilterChain, String, IoFilter.NextFilter)} or
     ...
     * @throws IoFilterLifeCycleException
     *             if {@link IoFilter#onPostRemove(IoFilterChain, String, IoFilter.NextFilter)} or
     ...
     * @throws Exception if {@link IoFilter#onPostRemove(IoFilterChain, String, IoFilter.NextFilter)} thrown an exception.
     */
    ...
    public interface Entry {
        ...
        /**
         * Returns the {@link IoFilter.NextFilter} of the filter.
         * 
         * @throws IllegalStateException if the {@link IoFilter.NextFilter} is not available
         */
