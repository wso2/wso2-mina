...
import org.wso2.org.apache.mina.common.IoSessionRecycler;
import org.wso2.org.apache.mina.common.RuntimeIOException;
import org.wso2.org.apache.mina.common.support.BaseIoAcceptor;
import org.wso2.org.apache.mina.common.support.IoServiceListenerSupport;
import org.wso2.org.apache.mina.transport.socket.nio.DatagramAcceptorConfig;
import org.wso2.org.apache.mina.transport.socket.nio.DatagramServiceConfig;
import org.wso2.org.apache.mina.transport.socket.nio.DatagramSessionConfig;
import org.wso2.org.apache.mina.util.NamePreservingRunnable;
...
public class DatagramAcceptorDelegate extends BaseIoAcceptor implements
    ...
    private boolean flush(DatagramSessionImpl session) throws IOException {
        ...
        try {
            for (;;) {
                IoFilter.WriteRequest req = writeRequestQueue.peek();
