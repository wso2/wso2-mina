...
import org.wso2.org.apache.mina.filter.support.Zlib;
...
public class CompressionFilterTest extends TestCase {
    ...
    public void testCompression() throws Exception {
        ...
        IoFilter.WriteRequest writeRequest = new IoFilter.WriteRequest(buf);
        ...
        nextFilter.filterWrite(session, new IoFilter.WriteRequest(actualOutput));
    ...
    class DataMatcher extends AbstractMatcher {
        protected boolean argumentMatches(Object arg0, Object arg1) {
            ...
            if (arg0 instanceof IoFilter.WriteRequest) {
                IoFilter.WriteRequest expected = (IoFilter.WriteRequest) arg0;
                IoFilter.WriteRequest actual = (IoFilter.WriteRequest) arg1;
